...
DELETE FROM profile WHERE id = $1 RETURNING id, user_id, firstname, lastname, gender, birthday, avatar_url, enable_2fa, secret_2fa, created_at, updated_at
`
...
UPDATE profile
   SET firstname = $1, lastname = $2, gender = $3, birthday = $4,
       avatar_url = $5, enable_2fa = $6, secret_2fa = $7
 WHERE id = $8 RETURNING id, user_id, firstname, lastname, gender, birthday, avatar_url, enable_2fa, secret_2fa, created_at, updated_at
`
