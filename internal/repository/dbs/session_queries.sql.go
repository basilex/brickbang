...
UPDATE session
SET access_token = $1, access_jti = $2, access_exp = $3,
    refresh_token = $4, refresh_jti = $5, refresh_exp = $6,
    updated_at = timezone('utc', now())
WHERE id = $7
RETURNING id, user_id, access_token, refresh_token, access_exp, refresh_exp, access_jti, refresh_jti, access_status, refresh_status, ip_address, user_agent, created_at, updated_at
`
...
UPDATE session
   SET access_token = $1, access_jti = $2, access_exp = $3
 WHERE id = $4 RETURNING id, user_id, access_token, refresh_token, access_exp, refresh_exp, access_jti, refresh_jti, access_status, refresh_status, ip_address, user_agent, created_at, updated_at
`
